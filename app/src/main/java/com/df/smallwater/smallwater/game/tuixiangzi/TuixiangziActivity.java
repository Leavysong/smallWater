...
import com.df.smallwater.smallwater.game.utils.GameView;
import com.df.smallwater.smallwater.game.utils.MyHelperUtils;
import com.df.smallwater.smallwater.game.utils.MyPassGameDialog;
import com.df.smallwater.smallwater.game.utils.PassAllLevesDialog;
import com.df.smallwater.smallwater.game.utils.ReturnMainDialog;
import com.df.smallwater.smallwater.game.utils.SoundPlay;

import java.io.IOException;
import java.io.InputStream;
import java.util.HashMap;

public class TuixiangziActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tuixiangzi);
        init_gameLevels();
        init();
    }
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    private void init()
    {
        ...
        soundPlay = new SoundPlay(TuixiangziActivity.this,loadSounds());
        ...
        public void handleMessage(Message msg) {
            if(msg.what == currentLevel){
                ...
                if(currentLevel<levels.length-1) {
                    ...
                    gameLevelTv.setText("第"+(currentLevel+1)+"关");
                    setTimer();
                    gameView = new GameView(TuixiangziActivity.this,levels[currentLevel][0],levels[currentLevel][1],
                            levels[currentLevel][2],levels[currentLevel][3],soundPlay);
    ...
    private void pushScoreDialog(){
        ...
        passDialog = new MyPassGameDialog(TuixiangziActivity.this,R.style.PassGameDialog,score);
        passDialog.show();
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TuixiangziActivity.this.finish();
            }
        });
    }

    private void pushPassAllGameDialog(){
        final PassAllLevesDialog allLevesDialog = new PassAllLevesDialog(TuixiangziActivity.this,R.style.PassGameDialog);
        allLevesDialog.show();
