...
//			initialize();
        ...
        private void initialize() {
            ...
            resetButton = new Button(Util.getPercentOfScreenWidth(72f),
                    height-Util.getPercentOfScreenHeight(18f),
                    -2f,
            ...
            saveButton = new Button(
                    Util.getPercentOfScreenWidth(42f),
                    height-Util.getPercentOfScreenHeight(18f),
                    -2,
                    Util.getPercentOfScreenWidth(26f),
                    Util.getPercentOfScreenHeight(13f));
